...
public class UpdateProfPage extends JFrame {
    ...
    public UpdateProfPage() {
        ...
        btnCloseApp.addActionListener(e -> {
            ...
            Main.getUpdateProfPage().setVisible(false);
        });
        ...
        btnUpdate.addActionListener(e -> {
            ...
            try {
                TeacherReadOnlyDTO teacherReadOnlyDTO = teacherService.updateTeacher(dto.getId(), updateDTO);
                    Main.getUpdateProfSuccessPage().setUuidText(teacherReadOnlyDTO.getUuid());
                    Main.getUpdateProfPage().setEnabled(false);
                    Main.getUpdateProfSuccessPage().setVisible(true);
    ...
    private TeacherUpdateDTO doDataBinding() {
        ...
        return new TeacherUpdateDTO(Main.getViewProfsPage().getSelectedId(), firstname, lastname, vat, fatherName, phoneNumber, mail, address, streetNo, cityId, postalCode);
    }
