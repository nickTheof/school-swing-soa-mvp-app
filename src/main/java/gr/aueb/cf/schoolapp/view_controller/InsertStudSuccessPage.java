...
public class InsertStudSuccessPage extends JFrame {
    ...
    public InsertStudSuccessPage() {
        ...
        btnClose.addActionListener(e -> {
            Main.getInsertStudPage().setEnabled(true);
            Main.getInsertStudSuccessPage().setVisible(false);
        });
        btnClose.setFont(new Font("Tahoma", Font.PLAIN, 12));
        btnClose.setBounds(345, 257, 184, 45);
        contentPane.add(btnClose);

        JLabel lblInsert = new JLabel("Εισαγωγή Σπουδαστή");
        ...
        JLabel successText = new JLabel("Ο σπουδαστής εισήχθηκε επιτυχώς");
