...
public class InsertProfSuccessPage extends JFrame {

    @Serial
    private static final long serialVersionUID = 1L;
    private final JLabel uuidText;


    public InsertProfSuccessPage() {
        ...
        btnClose.addActionListener(e -> {
            Main.getInsertProfPage().setEnabled(true);
            Main.getInsertProfSuccessPage().setVisible(false);
        });
        btnClose.setFont(new Font("Tahoma", Font.PLAIN, 12));
        btnClose.setBounds(345, 257, 184, 45);
        contentPane.add(btnClose);

        JLabel lblInsert = new JLabel("Εισαγωγή Εκπαιδευτή");
        ...
        JLabel successText = new JLabel("Ο εκπαιδευτής εισήχθηκε επιτυχώς");
